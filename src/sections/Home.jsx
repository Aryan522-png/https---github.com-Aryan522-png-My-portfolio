...
export default function Home(){
 ...
 const roles=useMemo(()=>["Web Developer" , "MERN stack developer" , "Cloud Engineer"],[])
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            <motion.div className="mb-3 text-xl ssm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white tracking-wide min-h-[1.6em]" 
            ...
            initial={{opacity:0}}
            animate={{opacity:1}}
            transition={{delay:0.8,duaration:0.8}}
            
            >
              <a href="#project" className="px-6 py-3 rounded-full font-medium text-lg text-white
             bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63]
             shadow-[0_3px_25px_rgba(0,255,180,0.6)]
             hover:shadow-[0_7px_15px_rgba(0,255,180,0.9)]
             hover:scale-105 transition-all">View My Work</a>
              <a href="/AryanWarekar_VitBhopal.pdf" download className="px-6 py-3 rounded-full text-lg font-medium text-black bg-white hover:bg-gray-200 shadow-2xl hover:scale-105 transition-all">My Resume</a>
            </motion.div>
        ...
        <div className="relative hidden lg:block">
          ...
          <motion.img src={avator} alt="" className="absolute top-1/2 -translate-y-1/2 object-contain select-none pointer-events-none "
