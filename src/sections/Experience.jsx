...
const experiences=[
   {
    ...
    duration: "2026",
    description: "Built a responsive Movie Booking Website that uses mongo DB , Clerk , Inngest .",
  },
  {
...
export default function Experience(){
  ...
  const SCENE_HEIGHT_VH=isMobile ?150*experiences.length : 120*experiences.length;
